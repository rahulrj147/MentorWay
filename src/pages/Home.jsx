  ...
  return (
    <div>
      ...
      <div className="relative mx-auto my-10 flex w-11/12   max-w-maxContent flex-col items-center justify-between gap-8 text-rich-">
        ...
        <Link to={"/signup"}>
          <div className="group mx-auto mt-16 w-fit rounded-full bg-richblack-800 p-1 font-bold text-richblack-100 drop-shadow-[0_1.5px_rgba(255,255,255,0.75)] transition-all duration-200 hover:scale-110 hover:drop-shadow-none">
        ...
        <div className="text-center text-4xl font-semibold">
          Strengthen Your Tomorrow with
          <HighlightText text={"Programming Expertise"} />
        </div>
          ...
          <div className="mb-10 mt-[-100px] flex flex-col justify-between gap-7 lg:mt-20 lg:flex-row lg:gap-0">
            ...
            <div className="flex flex-col items-start gap-10 lg:w-[40%]">
              <div className="text-[16px]">
                The modern MentorWay is the dictates its own terms. Today, to
